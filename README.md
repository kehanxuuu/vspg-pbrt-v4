...
This repository holds the renderer code for the SIGGRAPH ASIA 2024 paper "Volume Scattering Probability Guiding". The algorithm is implemented in [PBRT V4](https://github.com/mmp/pbrt-v4). For build instructions, refer to the original PBRT README, which is included at the end.
